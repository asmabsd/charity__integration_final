...
@Component({
  selector: 'app-listprojectsfrontcomponent',
  imports: [CommonModule, FormsModule,RouterModule],
  templateUrl: './listprojectsfrontcomponent.component.html',
  styleUrl: './listprojectsfrontcomponent.component.scss'
})
export class ListprojectsfrontcomponentComponent implements OnInit {
