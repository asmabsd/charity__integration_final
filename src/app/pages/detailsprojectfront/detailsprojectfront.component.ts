...
@Component({
  selector: 'app-detailsprojectfront',
  imports: [CommonModule],
  templateUrl: './detailsprojectfront.component.html',
  styleUrl: './detailsprojectfront.component.scss'
})
export class DetailsprojectfrontComponent implements OnInit {
